...
function redirectToRecommendation() {
    window.location.href = "recom(S).html"; // Replace "another-page.html" with the actual file name or URL of the page you want to navigate to
  }

function showGoogleStreetView() {
    var latitude = -6.20012120697451; // Replace with the desired latitude
    var longitude = 106.78546553945948; // Replace with the desired longitude
